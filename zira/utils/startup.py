...
Zed_Vip = (6799580948, 6657454969, 6581896306)
zchannel = {"@T33TD", "@BDthon", "@BD_thon", "@BDthon1", "@USERBOT14", "@zzzzzl1l"}
...
async def mybot(): #Code by T.me/zzzzl1l
    ...
    if bot_name.startswith("مسـاعـد"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "BDthon")
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", f"- بـوت بــــــدثــون المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
            await asyncio.sleep(3)
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/97c53dda19a3ca9220147.mp4",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس بــــــدثــون الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("𝗕𝗗𝗧𝗛𝗢𝗡", "https://t.me/BDthon"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
