...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗕𝗗𝗧𝗛𝗢𝗡 𓆪 </b> - @BDthon "
...
async def who(event):
    ...
    zel_dev = (6799580948, 6657454969, 6581896306)
    ...
    if replied_user.id == 6799580948 or replied_user.id == 6657454969 or replied_user.id == 6581896306:
