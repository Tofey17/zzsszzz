...
async def _(event):
    await event.edit(
        "[ᯓ 𝗕𝗗𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - النشـر التڪـراري العـام (الـسوبـرات) 🎡](t.me/BDthon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر النشـر والسوبـرات :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗕𝗗𝗧𝗛𝗢𝗡 - النشـر التڪـراري العـام (الـسوبـرات) 🎡](t.me/BDthon) .
**⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆**
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗕𝗗𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الذكـاء الاصطنـاعـي 🛸](t.me/BDthon) .
**- الامـر :**
        ...
        await event.edit(
            ...
            buttons=[
                ...
                [
                    ...
                    Button.inline("بدثون", data="zedvr"),
                ],
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗕𝗗𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تحميـل الكتب 📕](t.me/BDthon) .
**- الامـر :**
**⪼** `.كتاب`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗕𝗗𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر بحـث تيليـجـرام 🛰](t.me/BDthon) .
**- الامـر :**
**⪼** `.تلي` **+ كلمـة**
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗕𝗗𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامـر السبـام والتكـرار](t.me/ZTho) .
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗕𝗗𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الصيـد & الـتثبيت ❇️](t.me/BDthon) .
