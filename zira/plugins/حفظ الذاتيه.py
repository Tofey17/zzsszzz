...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗕𝗗𝗧𝗛𝗢𝗡 - حفـظ الذاتيـه 🧧](t.me/BDthon) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
